...
$_SESSION['open_emailmaker_site'] = "ListDripEmails";
...
$return_data = $EMAILMaker->GetDripsListviewData($show_module,$orderby, $dir);
...
$smarty->assign("VIEW_CONTENT", "ListDripEmails"); 
