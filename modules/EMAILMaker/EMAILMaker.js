...
function setEMAILMakerLicenseKey(form,type,confirm_str){
	form.installtype.value = type;
	if(type=='validate'){
		form.action.value = 'install';
		return true;
	}else if(type=='reactivate'){
		form.action.value = 'EMAILMakerAjax';
        form.file.value = 'ReactivateLicense';
		return true;
	}else if(type=='deactivate'){
		form.action.value = 'EMAILMakerAjax';
        form.file.value = 'DeactivateLicense';
		if(confirm(confirm_str)) return true;
		else return false;
	}else
		return false;
}
