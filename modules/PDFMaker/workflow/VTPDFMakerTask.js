...
function PDFMakerTask($) {
    ...
    function fillFolderBox(id)
    {
        ...
        new Ajax.Request(
                ...
                {queue: {position: 'end', scope: 'command'},
                    method: 'post',
                    postBody: "module=PDFMaker" + "&action=PDFMakerAjax&file=GetDocFolders&src_module=PDFMaker",
                    onComplete: function(response) {
                        ...
                        //$('#task_folder').attr("value", $("#task_folder option[value='0']").text());														
                    }
                }
        );
    }
    ...
    function fillTemplatesBox(id)
    {
        ...
        new Ajax.Request(
                ...
                {queue: {position: 'end', scope: 'command'},
                    method: 'post',
                    postBody: "module=PDFMaker" + "&action=PDFMakerAjax&file=GetPDFTemplates&src_module=PDFMaker&workflowid=" + workflowid,
                    onComplete: function(response) {
						var tpllang = response.responseText.split("%%%");
						// templates
                        ...
                        //$('#task_template').attr("value", $("#task_template option[value='0']").text());
                    }
                }
        );
    }
