<?php /* Smarty version Smarty-3.1.7, created on 2014-06-13 15:14:17
         compiled from "C:\xampp\htdocs\webclasscrm\includes\runtime/../../layouts/vlayout\modules\Settings\Leads\LeadMappingEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1520539b1549d634e3-30922621%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '206191d3d1a25f3538c8e1c72f92a449b24331fb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\webclasscrm\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Leads\\LeadMappingEdit.tpl',
      1 => 1401997418,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1520539b1549d634e3-30922621',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_539b1549ef5ac',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_539b1549ef5ac')) {function content_539b1549ef5ac($_smarty_tpl) {?>
<div class="container-fluid"><form id="leadsMapping"><div class="row-fluid settingsHeader padding1per"><span class="span8"><span class="font-x-x-large"><?php echo vtranslate('LBL_CONVERT_LEAD_FIELD_MAPPING',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_smarty_tpl->tpl_vars['LINK_MODEL']->_loop = true;
?><div class="pull-right actions"><span class="actionImages"><a><i title="<?php echo vtranslate($_smarty_tpl->tpl_vars['LINK_MODEL']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="icon-trash alignMiddle deleteMapping"></i></a></span></div><?php } ?></td></tr></tbody></table></div><div class="row-fluid"><span class="span4"><button id="addMapping" class="btn addButton" type="button"><i class="icon-plus icon-white"></i>&nbsp;<strong><?php echo vtranslate('LBL_ADD_MAPPING',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
